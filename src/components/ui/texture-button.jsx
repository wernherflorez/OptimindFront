...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      ...
      lime:
        "w-full border-[1px] dark:border-[2px] border-black/10 dark:border-[#0A0A0B] bg-gradient-to-b from-[#d8ff7a] to-[#C8FF4D] p-[1px] transition duration-300 ease-in-out",
    },
    size: {
      sm: "rounded-[6px]",
...
const innerDivVariants = cva("w-full h-full flex items-center justify-center text-muted-foreground", {
  variants: {
    variant: {
      ...
      lime:
        "gap-2 bg-gradient-to-b from-[#C8FF4D] to-[#a8e02e] text-sm font-semibold text-[#0A0A0B] transition duration-300 ease-in-out hover:from-[#d8ff7a] hover:to-[#C8FF4D] active:from-[#a8e02e] active:to-[#8FB838]",
    },
    size: {
